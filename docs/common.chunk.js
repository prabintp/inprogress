...
var CategoryService = (function () {
    function CategoryService(authService) {
    ...
    // Validate token request
    CategoryService.prototype.addCategory = function (body) {
        var _this = this;
    ...
    // Validate token request
    CategoryService.prototype.editCategory = function (body, id) {
        var _this = this;
        body.access_token = this.authService.currentAuthData.accessToken;
...
/***/ "../../../../../src/app/layout/contacts/contacts.service.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var ContactsService = (function () {
    function ContactsService(authService) {
        this.authService = authService;
        this.userOptions = {
            userPath: 'contacts'
        };
    ...
    // Validate token request
    ContactsService.prototype.getContactsByID = function (id) {
        var _this = this;
        var observ = this.authService.get(this.userOptions.userPath + '/' + id + '?access_token=' + this.authService.currentAuthData.accessToken);
        observ.subscribe(function (res) {
            _this.itemData = res.json();
    ...
    // Validate token request
    ContactsService.prototype.addContacts = function (body) {
        var _this = this;
        body.access_token = this.authService.currentAuthData.accessToken;
        body.shop = JSON.parse(this.authService.currentAuthData.currentShop).sid.id;
        body.createdBy = this.authService.currentAuthData.uid;
    ...
    // Validate token request
    ContactsService.prototype.editContacts = function (body, id) {
        var _this = this;
        body.access_token = this.authService.currentAuthData.accessToken;
        body.createdBy = this.authService.currentAuthData.uid;
        var observ = this.authService.put(this.userOptions.userPath + '/' + id, body);
    ...
    // Validate token request
    ContactsService.prototype.deleteItem = function (id) {
        //  body.access_token = this.authService.currentAuthData.accessToken;
        var observ = this.authService.delete(this.userOptions.userPath + '/' + id + '?access_token=' + this.authService.currentAuthData.accessToken);
        observ.subscribe(function (res) {
        }, function (error) {
...
/***/ "../../../../../src/app/layout/items/items.service.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var ItemsService = (function () {
    function ItemsService(authService) {
        this.authService = authService;
        this.userOptions = {
            userPath: 'items'
        };
    ...
    // Validate token request
    ItemsService.prototype.getItemsByID = function (id) {
        var _this = this;
        var observ = this.authService.get(this.userOptions.userPath + '/' + id + '?access_token=' + this.authService.currentAuthData.accessToken);
        observ.subscribe(function (res) {
            _this.itemData = res.json();
    ...
    // Validate token request
    ItemsService.prototype.addItems = function (body) {
        var _this = this;
        body.access_token = this.authService.currentAuthData.accessToken;
        body.shop = JSON.parse(this.authService.currentAuthData.currentShop).sid.id;
        body.createdBy = this.authService.currentAuthData.uid;
    ...
    // Validate token request
    ItemsService.prototype.editItems = function (body, id) {
        var _this = this;
        body.access_token = this.authService.currentAuthData.accessToken;
        body.createdBy = this.authService.currentAuthData.uid;
        var observ = this.authService.put(this.userOptions.userPath + '/' + id, body);
    ...
    ItemsService.prototype.getUnits = function () {
        var units;
        units = [
            {
                "code": "BAG",
...
/***/ "../../../../../src/app/layout/tax/tax.service.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var TaxService = (function () {
    function TaxService(authService) {
        this.authService = authService;
        this.userOptions = {
            userPath: 'taxes'
        };
    ...
    // Validate token request
    TaxService.prototype.getTaxByID = function (id) {
        var _this = this;
        var observ = this.authService.get(this.userOptions.userPath + '/' + id + '?access_token=' + this.authService.currentAuthData.accessToken);
        observ.subscribe(function (res) {
            _this.itemData = res.json();
    ...
    TaxService.prototype.getTax = function () {
        var _this = this;
        var observ = this.authService.get(this.userOptions.userPath + '?access_token=' + this.authService.currentAuthData.accessToken + '&shop=' + JSON.parse(this.authService.currentAuthData.currentShop).sid.id);
        observ.subscribe(function (res) {
            _this.itemData = res.json();
    ...
    // Validate token request
    TaxService.prototype.addTax = function (body) {
        var _this = this;
        body.access_token = this.authService.currentAuthData.accessToken;
        body.shop = JSON.parse(this.authService.currentAuthData.currentShop).sid.id;
        body.createdBy = this.authService.currentAuthData.uid;
    ...
    // Validate token request
    TaxService.prototype.editTax = function (body, id) {
        var _this = this;
        body.access_token = this.authService.currentAuthData.accessToken;
        var observ = this.authService.put(this.userOptions.userPath + '/' + id, body);
        observ.subscribe(function (res) {
    ...
    // Validate token request
    TaxService.prototype.deleteItem = function (id) {
        //  body.access_token = this.authService.currentAuthData.accessToken;
        var observ = this.authService.delete(this.userOptions.userPath + '/' + id + '?access_token=' + this.authService.currentAuthData.accessToken);
        observ.subscribe(function (res) {
        }, function (error) {
...
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "a", function() { return __WEBPACK_IMPORTED_MODULE_0__modules__["a"]; });
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "b", function() { return __WEBPACK_IMPORTED_MODULE_0__modules__["b"]; });
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "c", function() { return __WEBPACK_IMPORTED_MODULE_0__modules__["c"]; });
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "d", function() { return __WEBPACK_IMPORTED_MODULE_0__modules__["d"]; });
...
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "c", function() { return __WEBPACK_IMPORTED_MODULE_0__page_header_page_header_module__["a"]; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__login_form_login_form_module__ = __webpack_require__("../../../../../src/app/shared/modules/login-form/login-form.module.ts");
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "a", function() { return __WEBPACK_IMPORTED_MODULE_1__login_form_login_form_module__["a"]; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__stat_stat_module__ = __webpack_require__("../../../../../src/app/shared/modules/stat/stat.module.ts");
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "d", function() { return __WEBPACK_IMPORTED_MODULE_2__stat_stat_module__["a"]; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__modal_modal_module__ = __webpack_require__("../../../../../src/app/shared/modules/modal/modal.module.ts");
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "b", function() { return __WEBPACK_IMPORTED_MODULE_3__modal_modal_module__["a"]; });
...
/***/ "../../../../../src/app/shared/modules/login-form/login-form.component.html":
/***/ (function(module, exports) {

module.exports = "\r\n<!-- <form (ngSubmit)=\"onSignInSubmit()\" #f=\"ngForm\" >\r\n  <div class=\"row\">\r\n    <div class=\"input-field col s12\">\r\n      <input id=\"email\"\r\n             type=\"email\"\r\n             required\r\n             name='email' [(ngModel)]=\"signInUser.email\" class=\"validate\">\r\n      <label for=\"email\">Email</label>\r\n    </div>\r\n    <div class=\"input-field col s12\">\r\n      <input id=\"password\" type=\"password\" required  name='password' [(ngModel)]=\"signInUser.password\" class=\"validate\">\r\n      <label for=\"password\">Password</label>\r\n    </div>\r\n    <div class=\"col s12 \">\r\n      <button type=\"submit\" [disabled]=\"!(f.valid)\" class=\"waves-effect waves-light btn blue right\"> Login </button>\r\n    </div>\r\n  </div>\r\n</form> -->\r\n<form role=\"form\" (ngSubmit)=\"onSignInSubmit()\" #f=\"ngForm\">\r\n    <div class=\"form-content\">\r\n      <div class=\"form-group\">\r\n        <input\r\n          id=\"email\"\r\n          type=\"email\"\r\n          required\r\n          name='email' [(ngModel)]=\"signInUser.email\"\r\n          class=\"form-control input-underline input-lg validate\"  placeholder=\"Email\">\r\n      </div>\r\n      <div class=\"form-group\">\r\n        <input\r\n          id=\"password\" type=\"password\" required  name='password' [(ngModel)]=\"signInUser.password\"\r\n          class=\"form-control input-underline input-lg validate\" placeholder=\"Password\">\r\n      </div>\r\n    </div>\r\n    <button class=\"btn rounded-btn\" type=\"submit\" [disabled]=\"!(f.valid)\"> Log in </button>\r\n      &nbsp;\r\n    <button class=\"btn rounded-btn\" [routerLink]=\"['/signup']\">Register</button>\r\n  </form>\r\n"

/***/ }),

/***/ "../../../../../src/app/shared/modules/login-form/login-form.component.scss":
...
/***/ "../../../../../src/app/shared/modules/login-form/login-form.component.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var LoginFormComponent = (function () {
    function LoginFormComponent(authService, router) {
        ...
        this.onFormResult = new __WEBPACK_IMPORTED_MODULE_0__angular_core__["EventEmitter"]();
    }
    ...
    LoginFormComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            ...
            template: __webpack_require__("../../../../../src/app/shared/modules/login-form/login-form.component.html"),
            styles: [__webpack_require__("../../../../../src/app/shared/modules/login-form/login-form.component.scss")]
        }),
...
/***/ "../../../../../src/app/shared/modules/login-form/login-form.module.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__login_form_component__ = __webpack_require__("../../../../../src/app/shared/modules/login-form/login-form.component.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var LoginFormModule = (function () {
    ...
    LoginFormModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            imports: [__WEBPACK_IMPORTED_MODULE_1__angular_common__["CommonModule"], __WEBPACK_IMPORTED_MODULE_2__angular_router__["d" /* RouterModule */], __WEBPACK_IMPORTED_MODULE_3__angular_forms__["FormsModule"]],
            declarations: [__WEBPACK_IMPORTED_MODULE_5__login_form_component__["a" /* LoginFormComponent */]],
            exports: [__WEBPACK_IMPORTED_MODULE_5__login_form_component__["a" /* LoginFormComponent */]],
...
/***/ "../../../../../src/app/shared/modules/modal/modal.component.html":
/***/ (function(module, exports) {

module.exports = "<!--<button class=\"btn btn-primary\" (click)=\"open(content)\">Large modal</button>-->\r\n<a (click)=\"open(content)\" title=\"Delete\"><i class=\"fa fa-trash\"></i></a>\r\n  <ng-template #content let-c=\"close\" let-d=\"dismiss\">\r\n    <div class=\"modal-header\">\r\n        <h4 class=\"modal-title\">{{title}}</h4>\r\n        <button type=\"button\" class=\"close\" aria-label=\"Close\" (click)=\"d('Cross click')\">\r\n            <span aria-hidden=\"true\">&times;</span>\r\n        </button>\r\n    </div>\r\n    <div class=\"modal-body\">\r\n        <p>{{bodyContent}}</p>\r\n    </div>\r\n    <div class=\"modal-footer\">\r\n        <button type=\"button\" class=\"btn-small btn-secondary\" (click)=\"c('Close click')\">Cancel</button>\r\n        <button type=\"button\" class=\"btn btn-secondary\" (click)=\"onSuccess.emit();c('Close click');\">Delete</button>\r\n    </div>\r\n  </ng-template>\r\n"

/***/ }),

/***/ "../../../../../src/app/shared/modules/modal/modal.component.scss":
/***/ (function(module, exports, __webpack_require__) {
...
/***/ "../../../../../src/app/shared/modules/modal/modal.component.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var ModalComponent = (function () {
    ...
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Input"])(),
        __metadata("design:type", String)
    ], ModalComponent.prototype, "bodyContent", void 0);
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Output"])(),
        __metadata("design:type", Object)
    ], ModalComponent.prototype, "onSuccess", void 0);
    ModalComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'app-modal',
            template: __webpack_require__("../../../../../src/app/shared/modules/modal/modal.component.html"),
            styles: [__webpack_require__("../../../../../src/app/shared/modules/modal/modal.component.scss")]
        }),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_common__ = __webpack_require__("../../../common/esm5/common.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__angular_router__ = __webpack_require__("../../../router/esm5/router.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__modal_component__ = __webpack_require__("../../../../../src/app/shared/modules/modal/modal.component.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
module.exports = "<div class=\"row\">\r\n      <div class=\"col-xl-12\">\r\n        <h3 class=\"page-header pull-left text-muted\">\r\n            {{heading}}\r\n        </h3>\r\n        <button [routerLink]=\"addurl\" class=\"btn btn-info btn-sm pull-right\" >+ Add {{heading}}</button>\r\n      </div>\r\n</div>\r\n   <div class=\"row\">\r\n        <div class=\"col-xl-12\">\r\n        <ol class=\"breadcrumb\">\r\n            <li class=\"breadcrumb-item\">\r\n                <i class=\"fa fa-dashboard\"></i> <a href=\"Javascript:void(0)\" [routerLink]=\"['/dashboard']\">Dashboard</a>\r\n            </li>\r\n            <li class=\"breadcrumb-item active\"><i class=\"fa {{icon}}\"></i>\r\n              <a href=\"Javascript:void(0)\" [routerLink]=\"activeurl\"> {{heading}}</a>\r\n            </li>\r\n        </ol>\r\n    </div>\r\n</div>\r\n"
...
var PageHeaderComponent = (function () {
    ...
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Input"])(),
        __metadata("design:type", String)
    ], PageHeaderComponent.prototype, "addurl", void 0);
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Input"])(),
        __metadata("design:type", String)
    ], PageHeaderComponent.prototype, "activeurl", void 0);
...
var StatModule = (function () {
    ...
    StatModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            imports: [__WEBPACK_IMPORTED_MODULE_1__angular_common__["CommonModule"], __WEBPACK_IMPORTED_MODULE_3__angular_router__["d" /* RouterModule */]],
...
var AuthService = (function () {
    function AuthService(authService) {
        var _this = this;
        this.authService = authService;
        this.userSignedIn$ = new __WEBPACK_IMPORTED_MODULE_2_rxjs_Subject__["a" /* Subject */]();
        console.log('const');
        if (this.authService.currentAuthData) {
            this.authService.validateToken().subscribe(function (res) { return res.status === 200 || res.status === 304 ? _this.userSignedIn$.next(true) : _this.userSignedIn$.next(false); });
        }
    }
